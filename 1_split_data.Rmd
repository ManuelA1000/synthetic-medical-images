...
```{r}
all_irop <- read_csv('/Volumes/External Storage/irop_data/irop_07092020.csv') %>%
    clean_names() %>%
...
split_1 <- read_excel('/Volumes/External Storage/irop_data/all_splits_master_file.xlsx', sheet = 1) %>%
    clean_names() %>%
...
split_2 <- read_excel('/Volumes/External Storage/irop_data/all_splits_master_file.xlsx', sheet = 2) %>%
    clean_names() %>%
    separate(original_files, c('subject_id', NA, 'session', NA, 'eye', NA), sep = '_') %>%
    inner_join(all_irop, by = c('subject_id', 'eye', 'session')) %>%
    na_if('NULL.bmp') %>%
...
split_3 <- read_excel('/Volumes/External Storage/irop_data/all_splits_master_file.xlsx', sheet = 3) %>%
    clean_names() %>%
    separate(original_files, c('subject_id', NA, 'session', NA, 'eye', NA), sep = '_') %>%
    inner_join(all_irop, by = c('subject_id', 'eye', 'session')) %>%
    na_if('NULL.bmp') %>%
...
split_4 <- read_excel('/Volumes/External Storage/irop_data/all_splits_master_file.xlsx', sheet = 4) %>%
    clean_names() %>%
    separate(original_files, c('subject_id', NA, 'session', NA, 'eye', NA), sep = '_') %>%
    inner_join(all_irop, by = c('subject_id', 'eye', 'session')) %>%
    na_if('NULL.bmp') %>%
...
split_5 <- read_excel('/Volumes/External Storage/irop_data/all_splits_master_file.xlsx', sheet = 5) %>%
    clean_names() %>%
    separate(original_files, c('subject_id', NA, 'session', NA, 'eye', NA), sep = '_') %>%
    inner_join(all_irop, by = c('subject_id', 'eye', 'session')) %>%
    na_if('NULL.bmp') %>%
...
```{r}
src = '/Volumes/External Storage/irop_data/segmentations'
